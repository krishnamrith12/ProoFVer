...
class GENREHubInterface(BARTHubInterface):
    ...
    def sample(
        ...
        #print(sentences)
        #print("tokenised sents",tokenized_sentences)
        print("dfdsfd")
    ...
    def sample2(
            ...
            """for sentence in sentences:
                ...
                claim = sentence.split("</s>")[0]
                evids = sentence.split("</s>")[1:]
                print(claim,evids)"""
            tokenized_sentences = [self.encode(*sentence[0].split("</s>")) for sentence in sentences]
            #print("sentences in sample",sentences)
            #print("tokenised sents",tokenized_sentences)
            batched_hypos = self.generate(tokenized_sentences, beam, verbose, **kwargs)
            return [
                [
